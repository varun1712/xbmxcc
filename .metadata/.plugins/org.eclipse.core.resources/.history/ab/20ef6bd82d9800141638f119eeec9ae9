...
import info.androidhive.slidingmenu.util.AppController;
import info.androidhive.slidingmenu.model.Wallpaper;
import info.androidhive.slidingmenu.util.Utils;
...
public class FullScreen extends Activity implements OnClickListener {
